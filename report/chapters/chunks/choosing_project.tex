\subsubsection{The Reasons for Project Choice}
Much has been written about motivations in open source software
contributions {\footnote GET CITES!}, and I wanted to find out about the motivations behind people's choice of projects
to work on in this class. 
The {\bf overwhelming majority} (67\%) of question respondents (n=24) 
...
The narrative elaborations reveal that motivations are determined by alignment with personal
values, with skill sets 

{\it Interesting quotes from those elaborations:}\begin{itemize}
...
Of course, people elaborated on the other motivations as well:\begin{itemize}
